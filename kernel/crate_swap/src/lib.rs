...
pub fn swap_crates(
    ...
    for req in &swap_requests {
        ...
        {
            let mut new_crate = new_crate_ref.lock_as_mut().ok_or("BUG: swap_crates(): new_crate was unexpectedly shared in another namespace (couldn't get as exclusively mutable)...?")?;
